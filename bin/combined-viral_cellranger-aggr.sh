...
#SBATCH --job-name=aggr-viral
#SBATCH --output=log/cellranger/aggr-viral.log
#SBATCH --error=log/cellranger/aggr-viral.log
...
csv=$base_dir/docs/combined-viral_aggr.csv
name=combined-viral
