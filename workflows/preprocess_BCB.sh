...
bash bin/GRCh38-SCoV2_cellranger-mkref.sh
bash bin/combined_cellranger-mkfastq.sh
bash bin/combined_cellranger-count.sh
bash bin/combined_cellranger-aggr.sh
