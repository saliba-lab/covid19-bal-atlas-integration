...
filtered=data/BCh/random.h5ad
mapped=data/BCh/random_hlca.h5ad
plot_ann=analysis/BCh/random/celltypes

# Setup
python bin/method_filter.py -o $filtered --csv $csv --random $raw
